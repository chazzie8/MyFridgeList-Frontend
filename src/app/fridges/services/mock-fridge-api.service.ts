...
export class MockFridgeApiService {
  ...
  public getFridgeDashboardItems(): Observable<ApiResponse<FridgeDashboardItem[]>> {
    const res: ApiResponse<FridgeDashboardItem[]> = {
      success: true,
      data: [
        {
      ...
      data: [
        {
          ...
          timestamp: '2020-09-10T08:40:51.620Z',
        },
        {
